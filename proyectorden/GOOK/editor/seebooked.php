        ...
        <aside class="sidebar-left border-right bg-white shadow" id="leftSidebar" data-simplebar>
            ...
            <nav class="vertnav navbar navbar-light">
                ...
                <ul class="navbar-nav flex-fill w-100 mb-2">
                    ...
                    <li class="nav-item w-100">
                        <a class="nav-link" href="listbooked.php">
            ...
            <div class="container-fluid">
                ...
                <div class="col-12">
                    ...
                    <div class="col-1">
                        ...
                        <a href="rechazarbook.php?variable='<?php echo $variable;?>'"><button type="button" class="btn mb-2 btn-outline-danger">Rechazar</button></a>
                    </div>
                    <div class="col-1">
                        <a href="aprobarbook.php?variable=<?php echo $variable;?>"><button type="button" class="btn mb-2 btn-outline-success">Aprobar</button></a>
                    </div>
                    </div>
                </div>
