...
<head>
  ...
  <title>Ver GoodBook - Pagina Principal</title>
  <!-- Simple bar CSS -->
          ...
          <div class="col-12 mb-4">
            <div class="row">
              ...
              ?>
                ...
                <?php
                $idusu = $_SESSION['id'];
                $sql = $conexion->query("SELECT txttime FROM Comentario WHERE Usuario_idUsu='$idusu'");
                $datos = $sql->fetch_object();
                if (!empty($datos->txttime)) {
                  echo '<div class="card shadow mb-4">
                  <div class="card shadow">
                    <div class="card-header">
                      <strong class="card-title">Tu comentaste</strong>
                    </div>
                    <!-- / .card-body -->
                  </div> <!-- / .card -->
                </div>';
                ...
                where Libro_idLib ='$variable' and Usuario_idUsu = $idusu");
                while ($datos = $sql->fetch_object()) {
                ...
                <div class="row align-items-center">
                  <div class="col-auto">
                    ...
                    <strong class="card-title"><span class="avatar avatar-sm mt-2">
                        <img src="data:image/png;base64,base64_encode($datos->foto)">
                  ...
                  <div class="card-header">
                    <strong class="card-title"><span class="avatar avatar-sm mt-2">
                        <img src="data:image/png;base64,<?= base64_encode($_SESSION["foto"]) ?>">
                      </span><?php echo '$_SESSION['nombre1']'' '$_SESSION['apellido1']'</strong>
                  </div>
                  <div class="card-body">
                    <form class="needs-validation" novalidate="">
                      ...
                      <div class="custom-control custom-checkbox mb-3">
                        ...
                        <label class="custom-control-label" for="customControlValidation16">Acepto todos los terminos y condiciones</label>
                        <div class="invalid-feedback">Asegurese de aceptar los terminos y condiciones</div>
                      </div>
