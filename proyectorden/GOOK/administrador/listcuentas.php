      ...
      <main role="main" class="main-content">
        <div class="container-fluid">
          <div class="row justify-content-center">
              ...
              <div class="col-10">
                <h2 class="mb-2 page-title">Cuentas</h2>
                </div>
                
                <div  class="col-2">
                <a href="insertusu.php">
              <span class="fe fe-plus fe-16 mr-3"></span>Nueva Cuenta
...
<?php
                      ...
                      $sql = $conexion->query("SELECT * FROM Usuario;");
                       ...
                       while ($datos = $sql->fetch_array()) {
                           $idUsu = $datos['idUsu'];
                           $nomUsu = $datos['nom1']." ".$datos['nom2']." ".$datos['ape1']." ".$datos['ape2'];
                           $foto = $datos['foto'];
                           $edad = $datos['eda'];
                           $suscrip = $datos['Suscripcion_idSus'];
            ...
            <?php
                      ...
                      <div class="dropdown-menu dropdown-menu-right">
                        <a class="dropdown-item" href="editusu.php?variable='.$idUsu.'">Editar</a>
                        <a class="dropdown-item" href="deletusu.php?variable='.$idUsu.'">Eliminar</a>
                      </div>
                    </td>
                  </tr>';
