                            ...
                            <div class="col-md-12">
                                <div class="card shadow">
                                    <div class="card-body">
                                        ...
                                        echo '<div class="row">';
                                        $idAu=$variable;
                                        $sql = $conexion->query("SELECT * FROM Autor WHERE idAut=$idAu;");
                                        ...
                                        ?>
                                        <form action="../procesos/updateaut.php" method="POST" enctype="multipart/form-data">
                                            <section>
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        ...
                                                        <input type="text" name="nomaut1" class="form-control" value="<?php echo $nomAut1; ?>"required>
                                                    </div>  
                                                    <div class="form-group col-md-3">
                                                        <label for="catego">Segundo Nombre</label>
                                                        <input type="text" name="nomaut2" class="form-control" value="<?php echo $nomAut2; ?>">
                                                    </div>                  
                                                    <div class="form-group col-md-3">
                                                        <label for="catego">Primer Apellido</label>
                                                        <input type="text" name="apeaut1" class="form-control" value="<?php echo $apeAut1; ?>"required>
                                                    </div> 
                                                    <div class="form-group col-md-3">
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <textarea class="form-control" id="validationTextarea1" style=" font-size: x-large;height:80px;" id="example-fileinput" name="bio" class="form-control-file"  required><?php echo $bio; ?></textarea>
                                                    </div>                                                              
                                                </div>                                                
                                    </div>
