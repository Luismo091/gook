                            ...
                            <div class="col-md-12">
                                <div class="card shadow">
                                    <div class="card-body">
                                        ...
                                        echo '<div class="row">';
                                        $idCa=$variable;
                                        $sql = $conexion->query("SELECT * FROM Categoria WHERE idCat=$idCa;");
                                        ...
                                        ?>
                                        <form action="../procesos/updatecat.php" method="POST">
                                            <section>

                                                <div class="form-row">
                                                    <div class="form-group col-md-2">
                                                        <label for="id">ID</label>
                                                        <input type="text" name="idCat" class="form-control" value="<?php echo $idCat; ?>" readonly>
                                                    </div>
                                                
                                                    <div class="form-group col-md-10">
                                                        <label for="catego">Categoria</label>
                                                        <input type="text" name="nomcat" class="form-control" value="<?php echo $nomCat; ?>"required>
                                                    </div>  
