        ...
        <main role="main" class="main-content">
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-12">
                        <h2 class="mb-2 page-title">Editar Editorial</h2>
                        <p class="card-text"> </p>
                        <div class="row my-4">
                            <!-- Small table -->
                            <div class="col-md-12">
                                <div class="card shadow">
                                    <div class="card-body">
                                        ...
                                        echo '<div class="row">';
                                        $idEd=$variable;
                                        $sql = $conexion->query("SELECT * FROM Editorial WHERE idEdi=$idEd;");
                                        if ($datos = $sql->fetch_array()) {
                                            $idEdi = $datos['idEdi'];
                                            $nomEdi = $datos['nomEdi'];
                                            $foto_edi = $datos['foto_edi'];                                           
                                        }
                                        ...
                                        ?>
                                        <form action="../procesos/updateedi.php" method="POST" enctype="multipart/form-data">
                                            <section>
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-5">
                                                        ...
                                                        <input type="text" name="nomedi" class="form-control" value="<?php echo $nomEdi; ?>"required>
                                                    </div>  
                                
                                                    <div class="form-group col-md-5">
                                                        <label for="lastname">Imagen de la Editorial</label>
                                                        <input type="file" id="example-fileinput" name="imagenedi" class="form-control-file" required>
                                                    </div>   
