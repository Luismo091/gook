...
<body class="vertical  dark  ">
    ...
    <nav class="topnav navbar navbar-light">
      ...
      <form class="form-inline mr-auto searchform text-muted">
        <input class="form-control mr-sm-2 bg-transparent border-0 pl-4 text-muted" type="search"
          placeholder="Busca algo..." aria-label="Search">
      </form>
      <ul class="nav">
        <li class="nav-item">
  ...
  <article>
   ...
   xmlns:svg="http://www.w3.org/2000/svg"><sodipodi:namedview
     ...
     id="layer1"><g
       id="g509"
       transform="matrix(3.919041,0,0,3.919041,-72.733861,-141.06625)"><path
         style="display:none;fill:#ffffff;stroke:none;stroke-width:12.9118"
         ...
         style="display:none;fill:#f9f9f9;stroke:none;stroke-width:12.9118"
