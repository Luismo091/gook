...
type DocumentValidationStatusType = $Keys<typeof DocumentValidationStatus>;
...
declare class Bookmark extends Bookmark_base {
    ...
    static fromSerializableObject: (bookmark: Record<string, any>) => Bookmark;
}
...
interface EventMap {
    'viewState.change': (viewState: ViewState) => void;
...
type BaseFormFieldJSON = {
    type: 'pspdfkit/form-field/button' | 'pspdfkit/form-field/checkbox' | 'pspdfkit/form-field/combobox' | 'pspdfkit/form-field/listbox' | 'pspdfkit/form-field/radio' | 'pspdfkit/form-field/text' | 'pspdfkit/form-field/signature';
    pdfObjectId: number;
...
declare function serializeAnnotation<T extends Annotation>(annotation: T): IObject;
declare function serializeFormField(formField: FormField): Record<string, any>;
...
declare const PSPDFKit: {
    ...
    Annotations: {
        ...
        fromSerializableObject: (annotation: Record<string, unknown>) => Annotation;
    };
    AnnotationPresets: {
...
export { Action, Annotation, AnnotationToolbarItem, AnnotationsWillChangeReason, Bookmark, ButtonFormField, CheckBoxFormField, ChoiceFormField, Color, ComboBoxFormField, Comment, CommentMarkerAnnotation, Configuration, CustomOverlayItem, DrawingPoint, EllipseAnnotation, Font, FormField, FormFieldValue, FormOption, GoToAction, GoToEmbeddedAction, GoToRemoteAction, HideAction, HighlightAnnotation, ImageAnnotation, InkAnnotation, Inset, Instance, InstantClient, JavaScriptAction, LaunchAction, LineAnnotation, LinkAnnotation, List, ListBoxFormField, NamedAction, NoteAnnotation, PageInfo, Point, PolygonAnnotation, PolylineAnnotation, RadioButtonFormField, Rect, RectangleAnnotation, RedactionAnnotation, ResetFormAction, SearchResult, SearchState, ServerConfiguration, ShapeAnnotation, SignatureFormField, Size, SquiggleAnnotation, StampAnnotation, StandaloneConfiguration, StrikeOutAnnotation, SubmitFormAction, TextAnnotation, TextFormField, TextLine, TextMarkupAnnotation, PublicTextSelection as TextSelection, ToolbarItem, URIAction, UnderlineAnnotation, UnknownAnnotation, ViewState, WidgetAnnotation, PSPDFKit as default };
